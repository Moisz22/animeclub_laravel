      ...
      <div class="modal-content">
        <form>
            ...
            <div class="modal-body">
              <x-adminlte-input name="genero_id" wire:model="genero_id" label="id"
              fgroup-class="col-md-12 d-none" disable-feedback/>
              <div class="row">
                <x-adminlte-input name="genero_nombre" wire:model="nombre" label="Nombre" minlength="3" placeholder=""
